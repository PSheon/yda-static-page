...
import LOGO_FOLDED from 'assets/images/logos/logo-folded.jpg';
...
function Logo() {
  ...
  return (
    <div className={clsx(classes.root, 'flex items-center')}>
      <img className="logo-icon" src={LOGO_FOLDED} alt="logo" />
      <Typography
      ...
      <div
        className={clsx(
          classes.reactBadge,
          'react-badge flex items-center ml-12 mr-8 py-4 pl-8 pr-24 rounded-12'
        )}
      >
        {/* <img
        ...
        <img
          ...
          width="16"
        />
        <span className="react-text text-12 mx-4 whitespace-no-wrap">
          {userRoleTitleConverter(role)}
        </span>
      </div>
    </div>
  );
